...
public class PersonEditorGUI extends JFrame {
    ...
    private void saveButtonClicked() {
        ...
        a.setID(realID);
        i.setName(InameField.getText());
        i.setAddress(IaddressField.getText());
        i.setAge(Integer.parseInt(IageField.getText()));
        i.setID(Integer.parseInt(IrealIDField.getText()));
